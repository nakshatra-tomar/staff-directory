...
const AddEmployee = () => {
  ...
  const handleChange = (e) => {
    //e is event object
    const value = e.target.value; //55:30
      ...
      <div className="px-8 py-8 w-full">
        ...
        <div className="items-center justify-center h-14 w-full my-4">
          ...
          <input
            type="text"
            name="firstName"
            value={employee.firstName} // value tied to employee object //first name input field
        ...
        <div className="flex items-center justify-between h-14 w-full my-4 space-x-4 pt-4">
          <button
            ...
            className="rounded text-white font-semibold bg-green-500 hover:bg-green-700 py-2 px-4"
          >
            Save
          </button>
